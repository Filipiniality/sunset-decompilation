...
//
#define MB_SIDEWAYS_STAIRS_RIGHT_SIDE 0xD2
#define MB_SIDEWAYS_STAIRS_LEFT_SIDE 0xD3
#define MB_SIDEWAYS_STAIRS_RIGHT_SIDE_TOP 0xD4
#define MB_SIDEWAYS_STAIRS_LEFT_SIDE_TOP 0xD5
#define MB_SIDEWAYS_STAIRS_RIGHT_SIDE_BOTTOM 0xD6
#define MB_SIDEWAYS_STAIRS_LEFT_SIDE_BOTTOM 0xD7
//
