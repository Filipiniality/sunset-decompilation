...
const u16 gGraphics_TitleScreen_BoxArtMonPals[] = INCGFX_U16("graphics/title_screen_frlg/leafgreen/title_sunflora_palette.pal", ".gbapal");
const u8 gGraphics_TitleScreen_BoxArtMonTiles[] = INCGFX_U8("graphics/title_screen_frlg/leafgreen/title_sunflora.png", ".4bpp.smol");
const u8 gGraphics_TitleScreen_BoxArtMonMap[] = INCBIN_U8("graphics/title_screen_frlg/leafgreen/title_sunflora.bin.smolTM");
//const u16 gGraphics_TitleScreen_BackgroundPals[] = INCGFX_U16("graphics/title_screen_frlg/leafgreen/background.pal", ".gbapal");
const u16 gGraphics_TitleScreen_BackgroundPals[] = INCGFX_U16("graphics/title_screen_frlg/leafgreen/background_leaf.pal", ".gbapal");
const u8 gGraphics_TitleScreen_CopyrightPressStartTiles[] = INCGFX_U8("graphics/title_screen_frlg/copyright_press_start.png", ".4bpp.smol");
const u8 gGraphics_TitleScreen_CopyrightPressStartMap[] = INCBIN_U8("graphics/title_screen_frlg/copyright_press_start.bin.smolTM");
